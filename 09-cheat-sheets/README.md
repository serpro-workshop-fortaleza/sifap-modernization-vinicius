...
![Cartões de referência](https://img.shields.io/badge/Tipo-Refer%C3%AAncia%20r%C3%A1pida-171717?style=flat-square)
...
![Três cartões de referência rápida: Copilot em 3 modos, Spec-Kit em 1 página e escolha de modelo](../assets/cheat-sheets-index.svg)
...
| Anterior | Próximo |
|---|---|
| [Kits de persona — índice](../05-personas/README.md)<br/><sub>10 personas com agentes, prompts, skills e MCP específicos do papel.</sub> | [Copilot em 3 modos](copilot-3-modes.md)<br/><sub>Quando usar Ask, Plan ou Agent — uma tabela de situação para modo.</sub> |
